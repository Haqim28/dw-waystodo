  ...
  return (
    ...
    <Text fontFamily="body" fontWeight={400}  fontSize={50} bold>
      ...
      Fast, Simple and Easy to Use
        ...
        <TouchableOpacity style={{backgroundColor: '#FF5555', height: 40, width: 310, borderRadius: 5,justifyContent: 'center' , marginTop: 120}}>
            <Text style={{color: '#FFF', fontWeight: 'bold', borderRadius: 5, textAlign: 'center' }}>Login</Text>
        </TouchableOpacity>

        <TouchableOpacity style={{backgroundColor: '#0000004F', height: 40, width: 310, borderRadius: 5,justifyContent: 'center', marginTop:10}}>
